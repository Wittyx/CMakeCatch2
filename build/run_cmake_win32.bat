...
echo CurrentFolder is: %CurrentFolder%
set BUILD=%CurrentFolder%\bld_2019\
...
%CMake_Exe% ^
	...
	-DCMAKE_RUNTIME_OUTPUT_DIRECTORY="%CD%\..\..\output\win32\bin" ^
	-DCMAKE_LIBRARY_OUTPUT_DIRECTORY="%CD%\..\..\output\win32\bin" ^
	-DCMAKE_ARCHIVE_OUTPUT_DIRECTORY="%CD%\..\..\output\win32\lib" ^
